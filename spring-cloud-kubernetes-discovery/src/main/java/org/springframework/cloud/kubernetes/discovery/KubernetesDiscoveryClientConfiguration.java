...
public class KubernetesDiscoveryClientConfiguration {
    ...
    @Bean
    public KubernetesDiscoveryLifecycle kubernetesDiscoveryLifecycle(KubernetesClient client, KubernetesDiscoveryProperties properties, ServiceRegistry<? extends Registration> serviceRegistry) {
        return new KubernetesDiscoveryLifecycle(client, properties, serviceRegistry);
